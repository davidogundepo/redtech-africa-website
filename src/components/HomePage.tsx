    ...
    <div className={`min-h-screen transition-all duration-500 overflow-hidden ${
      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="absolute top-0 right-0 w-full lg:w-[55%] h-full overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-gray-900 via-gray-900/80 to-transparent z-10 lg:block hidden" />
          <div className={`absolute inset-0 z-10 lg:hidden ${isDark ? 'bg-gray-900/70' : 'bg-white/70'}`} />
          <img
      ...
      <section className="relative py-32 px-6 sm:px-8 lg:px-16 overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            className="w-full h-full object-cover"
          />
          <div className={`absolute inset-0 ${isDark ? 'bg-gray-900/90' : 'bg-white/90'}`} />
        </div>
